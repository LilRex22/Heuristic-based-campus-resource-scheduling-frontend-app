function Footer(){
    return (
        <footer className="container-fluid shadow p-3 d-lg-flex d-column justify-content-lg-between justify-content-center" style={{marginTop: '100px', backgroundColor: 'white', zIndex: 2}}>
